...
const DataKK = () => {
  ...
  const searchFunc =(value) =>{
    return (value.nama_kepala.toLowerCase().includes(query.toLowerCase()) || value.no_kk.toLowerCase().includes(query.toLowerCase())) && value.desa.nama_desa.includes(filterDesa) && value.dusun.nama_dusun.includes(filterDusun)
  }
