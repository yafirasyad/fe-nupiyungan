...
const FormEditKk = () => {
    ...
    useEffect(() => {
        ...
        setAtap(dataState.selectedDataKk.atap)
        setJendela(dataState.selectedDataKk.jendela)
        setPenerangan(dataState.selectedDataKk.penerangan)
        setMck(dataState.selectedDataKk.mck)
        setEnergiMasak(dataState.selectedDataKk.energi_masak)
        setPembuangan(dataState.selectedDataKk.pembuangan)
        setSumberAirMandi(dataState.selectedDataKk.sumber_air_mandi)
        setSumberAirMinum(dataState.selectedDataKk.sumber_air_minum)
        setRumahDibawahSutet(dataState.selectedDataKk.rumah_dibawah_sutet)
        setRumahBantaranSungai(dataState.selectedDataKk.rumah_bantaran_sungai)
        setKondisiRumah(dataState.selectedDataKk.kondisi_rumah)
        setBltDesa(dataState.selectedDataKk.blt_desa)
        setPkh(dataState.selectedDataKk.pkh)
        setBantuanSosialTunai(dataState.selectedDataKk.bantuan_sosial_tunai)
        setBantuanPresiden(dataState.selectedDataKk.bantuan_presiden)
        setBantuanUmkm(dataState.selectedDataKk.bantuan_umkm)
        setBantuanPekerja(dataState.selectedDataKk.bantuan_pekerja)
        setBantuanPendidikan(dataState.selectedDataKk.bantuan_pendidikan)
        setAksesKerja(dataState.selectedDataKk.akses_kerja)
        ...
        setRs({
            fasilitas: 'Rumah Sakit',
            jarak: dataState.selectedDataKk.akses_fasilitas_kesehatan[0].jarak,
            waktu: dataState.selectedDataKk.akses_fasilitas_kesehatan[0].waktu,
            kemudahan: dataState.selectedDataKk.akses_fasilitas_kesehatan[0].kemudahan,
        })

        setRsb({
            fasilitas: 'Rumah Sakit Bersalin',
            jarak: dataState.selectedDataKk.akses_fasilitas_kesehatan[1].jarak,
            waktu: dataState.selectedDataKk.akses_fasilitas_kesehatan[1].waktu,
            kemudahan: dataState.selectedDataKk.akses_fasilitas_kesehatan[1].kemudahan,
        })

        setPoliklinik({
            fasilitas: 'Poliklinik',
            jarak: dataState.selectedDataKk.akses_fasilitas_kesehatan[2].jarak,
            waktu: dataState.selectedDataKk.akses_fasilitas_kesehatan[2].waktu,
            kemudahan: dataState.selectedDataKk.akses_fasilitas_kesehatan[2].kemudahan,
        })

        setPuskesmas({
            fasilitas: 'Puskesmas',
            jarak: dataState.selectedDataKk.akses_fasilitas_kesehatan[3].jarak,
            waktu: dataState.selectedDataKk.akses_fasilitas_kesehatan[3].waktu,
            kemudahan: dataState.selectedDataKk.akses_fasilitas_kesehatan[3].kemudahan,
        })

        setPuskesmasBantu({
            fasilitas: 'Puskesmas Bantu',
            jarak: dataState.selectedDataKk.akses_fasilitas_kesehatan[4].jarak,
            waktu: dataState.selectedDataKk.akses_fasilitas_kesehatan[4].waktu,
            kemudahan: dataState.selectedDataKk.akses_fasilitas_kesehatan[4].kemudahan,
        })

        setPolindes({
            fasilitas: 'Polindes',
            jarak: dataState.selectedDataKk.akses_fasilitas_kesehatan[5].jarak,
            waktu: dataState.selectedDataKk.akses_fasilitas_kesehatan[5].waktu,
            kemudahan: dataState.selectedDataKk.akses_fasilitas_kesehatan[5].kemudahan,
        })

        setPoskesdes({
            fasilitas: 'Poskesdes',
            jarak: dataState.selectedDataKk.akses_fasilitas_kesehatan[6].jarak,
            waktu: dataState.selectedDataKk.akses_fasilitas_kesehatan[6].waktu,
            kemudahan: dataState.selectedDataKk.akses_fasilitas_kesehatan[6].kemudahan,
        })

        setPosyandu({
            fasilitas: 'Posyandu',
            jarak: dataState.selectedDataKk.akses_fasilitas_kesehatan[7].jarak,
            waktu: dataState.selectedDataKk.akses_fasilitas_kesehatan[7].waktu,
            kemudahan: dataState.selectedDataKk.akses_fasilitas_kesehatan[7].kemudahan,
        })

        setApotek({
            fasilitas: 'Apotek',
            jarak: dataState.selectedDataKk.akses_fasilitas_kesehatan[8].jarak,
            waktu: dataState.selectedDataKk.akses_fasilitas_kesehatan[8].waktu,
            kemudahan: dataState.selectedDataKk.akses_fasilitas_kesehatan[8].kemudahan,
        })

        // Akses Pendidikan
        setPaud({
            fasilitas: 'PAUD',
            jarak: dataState.selectedDataKk.akses_fasilitas_pendidikan[0].jarak,
            waktu: dataState.selectedDataKk.akses_fasilitas_pendidikan[0].waktu,
            kemudahan: dataState.selectedDataKk.akses_fasilitas_pendidikan[0].kemudahan,
        })

        setTk({
            fasilitas: 'TK/RA',
            jarak: dataState.selectedDataKk.akses_fasilitas_pendidikan[1].jarak,
            waktu: dataState.selectedDataKk.akses_fasilitas_pendidikan[1].waktu,
            kemudahan: dataState.selectedDataKk.akses_fasilitas_pendidikan[1].kemudahan,
        })

        setSd({
            fasilitas: 'SD/MI/Sederajat',
            jarak: dataState.selectedDataKk.akses_fasilitas_pendidikan[2].jarak,
            waktu: dataState.selectedDataKk.akses_fasilitas_pendidikan[2].waktu,
            kemudahan: dataState.selectedDataKk.akses_fasilitas_pendidikan[2].kemudahan,
        })

        setSmp({
            fasilitas: 'SMP/MTs/Sederajat',
            jarak: dataState.selectedDataKk.akses_fasilitas_pendidikan[3].jarak,
            waktu: dataState.selectedDataKk.akses_fasilitas_pendidikan[3].waktu,
            kemudahan: dataState.selectedDataKk.akses_fasilitas_pendidikan[3].kemudahan,
        })

        setSma({
            fasilitas: 'SMA/MA/Sederajat',
            jarak: dataState.selectedDataKk.akses_fasilitas_pendidikan[4].jarak,
            waktu: dataState.selectedDataKk.akses_fasilitas_pendidikan[4].waktu,
            kemudahan: dataState.selectedDataKk.akses_fasilitas_pendidikan[4].kemudahan,
        })

        setPt({
            fasilitas: 'Perguruan Tinggi',
            jarak: dataState.selectedDataKk.akses_fasilitas_pendidikan[5].jarak,
            waktu: dataState.selectedDataKk.akses_fasilitas_pendidikan[5].waktu,
            kemudahan: dataState.selectedDataKk.akses_fasilitas_pendidikan[5].kemudahan,
        })

        setPesantren({
            fasilitas: 'Pesantren',
            jarak: dataState.selectedDataKk.akses_fasilitas_pendidikan[6].jarak,
            waktu: dataState.selectedDataKk.akses_fasilitas_pendidikan[6].waktu,
            kemudahan: dataState.selectedDataKk.akses_fasilitas_pendidikan[6].kemudahan,
        })

        setSeminari({
            fasilitas: 'Seminari',
            jarak: dataState.selectedDataKk.akses_fasilitas_pendidikan[7].jarak,
            waktu: dataState.selectedDataKk.akses_fasilitas_pendidikan[7].waktu,
            kemudahan: dataState.selectedDataKk.akses_fasilitas_pendidikan[7].kemudahan,
        })

        setKeagamaanLain({
            fasilitas: 'Pendidikan Keagamaan Lain',
            jarak: dataState.selectedDataKk.akses_fasilitas_pendidikan[8].jarak,
            waktu: dataState.selectedDataKk.akses_fasilitas_pendidikan[8].waktu,
            kemudahan: dataState.selectedDataKk.akses_fasilitas_pendidikan[8].kemudahan,
        })
                  ...
                  <div className="mb-3">
                    ...
                    <div className="form-check">
                      <input
                        ...
                        checked={tempatTinggal === 'Milik Sendiri'}
                      />
                    ...
                    <div className="form-check">
                      <input
                        ...
                        value="Bebas Sewa"
                        onChange={handleTempatTinggalChange}
                        checked={tempatTinggal === 'Bebas Sewa'}
                      />
                    ...
                    <div className="form-check">
                      <input
                        ...
                        value="Dipinjami"
                        onChange={handleTempatTinggalChange}
                        checked={tempatTinggal === 'Dipinjami'}
                      />
                    ...
                    <div className="form-check">
                      <input
                        ...
                        value="Other"
                        onChange={handleTempatTinggalChange}
                        checked={tempatTinggal !== 'Milik Sendiri' && tempatTinggal !== 'Kontrak' && tempatTinggal !== 'Bebas Sewa' && tempatTinggal !== 'Dipinjami' && tempatTinggal !== 'Dinas'}
                      />
                  ...
                  <div className="mb-3">
                    ...
                    <div className="form-check">
                      <input
                        ...
                        onChange={handlelantaiChange}
                        checked={lantai === 'Kayu/Papan Kualitas Rendah'}
                      />
                    ...
                    <div className="form-check">
                      <input
                        ...
                        onChange={handlelantaiChange}
                        checked={lantai === 'Semen/Batam Merah'}
                      />
                    ...
                    <div className="form-check">
                      <input
                        ...
                        value="Other"
                        onChange={handlelantaiChange}
                        checked={lantai !== 'Marmer/Granit' && lantai !== 'Keramik' && lantai !== 'Vinil' && lantai !== 'Ubin/Tegel' && lantai !== 'Kayu Tinggi' && lantai !== 'Kayu/Papan Kualitas Rendah' && lantai !== 'Semen/Batam Merah' && lantai !== 'Bambu'}
                      />
                  ...
                  <div className="mb-3">
                    ...
                    <div className="form-check">
                      <input
                        ...
                        checked={dinding === 'Semen/Beton/Kayu Berkualitas Tinggi'}
                      />
                    ...
                    <div className="form-check">
                      <input
                        ...
                        onChange={handleDindingChange}
                        checked={dinding === 'Kayu berkualitas rendah/bambu'}
                      />
                    ...
                    <div className="form-check">
                      <input
                        ...
                        value="Other"
                        onChange={handleDindingChange}
                        checked={dinding !== 'Semen/Beton/Kayu Berkualitas Tinggi' && dinding !== 'Kayu berkualitas rendah/bambu'}
                      />
                  ...
                  <div className="mb-3">
                    ...
                    <div className="form-check">
                      <input
                        ...
                        onChange={(e) => setJendela(e.target.value)}
                        checked={jendela === 'Ada, tak berfungsi'}
                      />
                    ...
                    <div className="form-check">
                      <input
                        ...
                        onChange={(e) => setJendela(e.target.value)}
                        checked={jendela === 'Tidak ada jendela'}
                      />
                  ...
                  <div className="mb-3">
                    ...
                    <div className="form-check">
                      <input
                        ...
                        value="Other"
                        onChange={handleAtapChange}
                        checked={atap !== 'Genteng' && atap !== 'Kayu/Jerami'}
                      />
                  ...
                  <div className="mb-3">
                    ...
                    <div className="form-check">
                      <input
                        ...
                        checked={penerangan === 'Listrik PLN'}
                      />
                    ...
                    <div className="form-check">
                      <input
                        ...
                        onChange={handlePeneranganChange}
                        checked={penerangan === 'Listrik Non PLN'}
                      />
                    ...
                    <div className="form-check">
                      <input
                        ...
                        value="Lampu Minyak"
                        onChange={handlePeneranganChange}
                        checked={penerangan === 'Lampu Minyak'}
                      />
                    ...
                    <div className="form-check">
                      <input
                        ...
                        onChange={handlePeneranganChange}
                        checked={penerangan === 'Tidak Ada Penerangan'}
                      />
                    ...
                    <div className="form-check">
                      <input
                        ...
                        value="Other"
                        onChange={handlePeneranganChange}
                        checked={penerangan !== 'Listrik PLN' && penerangan !== 'Listrik Non PLN' && penerangan !== 'Lampu Minyak' && penerangan !== 'Tidak Ada Penerangan'}
                      />
                  ...
                  <div className="mb-3">
                    ...
                    <div className="form-check">
                      <input
                        ...
                        checked={energiMasak === 'Gas LPG/Biogas'}
                      />
                    ...
                    <div className="form-check">
                      <input
                        ...
                        value="Kayu Bakar"
                        onChange={handleEnergiMasakChange} 
                        checked={energiMasak === 'Kayu Bakar'}
                      />
                    ...
                    <div className="form-check">
                      <input
                        ...
                        value="Minyak Tanah"
                        onChange={handleEnergiMasakChange}
                        checked={energiMasak === 'Minyak Tanah'}
                      />
                    ...
                    <div className="form-check">
                      <input
                        ...
                        value="Other"
                        onChange={handleEnergiMasakChange}
                        checked={energiMasak !== 'Gas LPG/Biogas' && energiMasak !== 'Kayu Bakar' && energiMasak !== 'Minyak Tanah'}
                      />
                  ...
                  <div className="mb-3">
                    ...
                    <div className="form-check">
                      <input
                        ...
                        checked={pembuangan === 'Kebun/sungai/drainase'}
                      />
                    ...
                    <div className="form-check">
                      <input
                        ...
                        onChange={(e) => setPembuangan(e.target.value)}
                        checked={pembuangan === 'Sampah diangkut reguler'}
                      />
                  ...
                  <div className="mb-3">
                    ...
                    <div className="form-check">
                      <input
                        ...
                        onChange={(e) => setMck(e.target.value)}
                        checked={mck === 'Berkelompok/tetangga'}
                      />
                  ...
                  <div className="mb-3">
                    ...
                    <div className="form-check">
                      <input
                        ...
                        onChange={handleSumberAirMandiChange}
                        checked={sumberAirMandi === 'Ledeng/perpiaan berbayar'}
                      />
                    ...
                    <div className="form-check">
                      <input
                        ...
                        onChange={handleSumberAirMandiChange}
                        checked={sumberAirMandi === 'Sungai/danau/embung'}
                      />
                    ...
                    <div className="form-check">
                      <input
                        ...
                        onChange={handleSumberAirMandiChange}
                        checked={sumberAirMandi === 'Tadah air hujan'}
                      />
                    ...
                    <div className="form-check">
                      <input
                        ...
                        value="Other"
                        onChange={handleSumberAirMandiChange}
                        checked={sumberAirMandi !== 'Sumur' && sumberAirMandi !== 'Ledeng/perpiaan berbayar' && sumberAirMandi !== 'Sungai/danau/embung' && sumberAirMandi !== 'Tadah air hujan'}
                      />
                  ...
                  <div className="mb-3">
                    ...
                    <div className="form-check">
                      <input
                        ...
                        value="Ledeng/perpiaan berbayar"
                        onChange={handleSumberAirMinumChange}
                        checked={sumberAirMinum === 'Ledeng/perpiaan berbayar'}
                      />
                    ...
                    <div className="form-check">
                      <input
                        ...
                        value="Sungai/danau/embung"
                        onChange={handleSumberAirMinumChange}
                        checked={sumberAirMinum === 'Sungai/danau/embung'}
                      />
                    ...
                    <div className="form-check">
                      <input
                        ...
                        value="Tadah air hujan"
                        onChange={handleSumberAirMinumChange}
                        checked={sumberAirMinum === 'Tadah air hujan'}
                      />
                    ...
                    <div className="form-check">
                      <input
                        ...
                        value="Other"
                        onChange={handleSumberAirMinumChange}
                        checked={sumberAirMinum !== 'Sumur' && sumberAirMinum !== 'Ledeng/perpiaan berbayar' && sumberAirMinum !== 'Sungai/danau/embung' && sumberAirMinum !== 'Tadah air hujan'}
                      />
