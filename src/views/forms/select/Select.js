...
const Select = () => {
    ...
    return ( <
        ...
        /> <
        ModalSubmitState visible = { isModalVisible }
        ...
        value = { namaKepala }
        onChange = {
            (e) => setNamaKepala(e.target.value) }
        required /
        >
        <
        /div> <
        InputDesa selectedDesa = { desa }
        setSelectedDesa = { setDesa }
        selectedDusun = { dusun }
        setSelectedDusun = { setDusun }
        /> <
        div className = "mb-3" >
        <
        CFormLabel htmlFor = "kotaknu" >
        Sudah memiliki kotak NU & nbsp; <
        /CFormLabel> <
        select id = "kotaknu"
        name = "kotaknu"
        value = { kotakNu }
        onChange = {
            (e) => setKotakNu(e.target.value) } >
        <
        ...
        <
        h6 > Tempat Tinggal yang ditempati: & nbsp; < /h6> <
        /CFormLabel> <
        br > < /br> <
        ...
        <
        h6 > Jenis lantai tempat tinggal terluas & nbsp; < /h6> <
        /CFormLabel> <
        br > < /br> <
        div className = "form-check" >
        <
        ...
        <
        h6 > Dinding sebagian besar rumah & nbsp; < /h6> <
        /CFormLabel> <
        br > < /br> <
        div className = "form-check" >
        <
        ...
        value = "Ada, berfungsi"
        onChange = {
            (e) => setJendela(e.target.value) }
        /> <
        label className = "form-check-label"
        htmlFor = "adaberfungsi" >
        Ada, berfungsi <
        /label> <
        /div> <
        div className = "form-check" >
        ...
        <
        h6 > Energi Untuk Memasak & nbsp; < /h6> <
        /CFormLabel> <
        br > < /br> <
        div className = "form-check" >
        <
        ...
        <
        h6 > Tempat pembuangan sampah & nbsp; < /h6> <
        /CFormLabel> <
        br > < /br> <
        div className = "form-check" >
        <
        ...
        onChange = {
            (e) => setPembuangan(e.target.value) }
        /> <
        label className = "form-check-label"
        htmlFor = "dikebun" >
        ...
        Rumah berada di bawah sutet / sutt / suttas & nbsp; <
        /CFormLabel> <
        select id = "rumahsutet"
        name = "rumahsutet"
        value = { rumahDibawahSutet }
        onChange = {
            (e) => setRumahDibawahSutet(e.target.value) } >
        <
        option value = { 1 } > Ya < /option> <
        option value = { 0 } > Tidak < /option> <
        /select> <
        ...
        Rumah berada di bantaran sungai & nbsp; <
        /CFormLabel> <
        select id = "rumahsungai"
        name = "rumahsungai"
        value = { rumahBantaranSungai }
        onChange = {
            (e) => setRumahBantaranSungai(e.target.value) } >
        <
        option value = { 1 } > Ya < /option> <
        option value = { 0 } > Tidak < /option> <
        /select> <
        ...
        secara keseluruhan kondisi rumah & nbsp; <
        /CFormLabel> <
        select id = "kondisirumah"
        name = "kondisirumah"
        value = { kondisiRumah }
        onChange = {
            (e) => setKondisiRumah(e.target.value) } >
        <
        ...
        /CFormLabel> <
        br > < /br> <
        CFormLabel htmlFor = "bltdanadesa" > BLT dana desa & nbsp; < /CFormLabel> <
        select id = "bltdanadesa"
        name = "bltdanadesa"
        value = { bltDesa }
        onChange = {
            (e) => setBltDesa(e.target.value) } >
        <
        option value = { 1 } > Ya < /option> <
        option value = { 0 } > Tidak < /option> <
        /select> <
        br > < /br> <
        CFormLabel htmlFor = "keluargaharapan" > Program Keluarga Harapan & nbsp; < /CFormLabel> <
        select id = "keluargaharapan"
        name = "keluargaharapan"
        value = { pkh }
        onChange = {
            (e) => setPkh(e.target.value) } >
        <
        option value = { 1 } > Ya < /option> <
        option value = { 0 } > Tidak < /option> <
        /select> <
        br > < /br> <
        CFormLabel htmlFor = "bantaunsosialtunai" > Bantuan Sosial Tunai & nbsp; < /CFormLabel> <
        select id = "bantaunsosialtunai"
        name = "bantaunsosialtunai"
        value = { bantuanSosialTunai }
        onChange = {
            (e) => setBantuanSosialTunai(e.target.value) } >
        <
        option value = { 1 } > Ya < /option> <
        option value = { 0 } > Tidak < /option> <
        /select> <
        br > < /br> <
        CFormLabel htmlFor = "bantuanpresiden" > Bantuan Presiden & nbsp; < /CFormLabel> <
        select id = "bantuanpresiden"
        name = "bantuanpresiden"
        value = { bantuanPresiden }
        onChange = {
            (e) => setBantuanPresiden(e.target.value) } >
        <
        option value = { 1 } > Ya < /option> <
        option value = { 0 } > Tidak < /option> <
        /select> <
        br > < /br> <
        CFormLabel htmlFor = "bantuanumkm" > Bantuan UMKM & nbsp; < /CFormLabel> <
        select id = "bantuanumkm"
        name = "bantuanumkm"
        value = { bantuanUmkm }
        onChange = {
            (e) => setBantuanUmkm(e.target.value) } >
        <
        option value = { 1 } > Ya < /option> <
        option value = { 0 } > Tidak < /option> <
        /select> <
        ...
        Bantuan untuk Pekerja & nbsp; <
        /CFormLabel> <
        select id = "bantuanuntukpekerja"
        name = "bantuanuntukpekerja"
        value = { bantuanPekerja }
        onChange = {
            (e) => setBantuanPekerja(e.target.value) } >
        <
        option value = { 1 } > Ya < /option> <
        option value = { 0 } > Tidak < /option> <
        /select> <
        ...
        Bantuan pendidikan anak & nbsp; <
        /CFormLabel> <
        select id = "bantuanpendidikananak"
        name = "bantuanpendidikananak"
        value = { bantuanPendidikan }
        onChange = {
            (e) => setBantuanPendidikan(e.target.value) } >
        <
        option value = { 1 } > Ya < /option> <
        option value = { 0 } > Tidak < /option> <
        /select> <
        ...
        value = { paud.jarak }
        onChange = {
            (e) => setPaud({...paud, jarak: e.target.value }) }
        required /
        >
        <
        /CFormLabel> &
        ...
        value = { paud.waktu }
        onChange = {
            (e) => setPaud({...paud, waktu: e.target.value }) }
        required /
        >
        <
        /CFormLabel> &
        ...
        Mudah / Sulit ? :
        <
        select id = "kemudahanpaud"
        name = "kemudahanpaud"
        value = { paud.kemudahan }
        onChange = {
            (e) => setPaud({...paud, kemudahan: e.target.value }) } >
        <
        ...
        value = { tk.jarak }
        onChange = {
            (e) => setTk({...tk, jarak: e.target.value }) }
        required /
        >
        <
        /CFormLabel> &
        ...
        value = { tk.waktu }
        onChange = {
            (e) => setTk({...tk, waktu: e.target.value }) }
        required /
        >
        <
        /CFormLabel> &
        ...
        Mudah / Sulit ? :
        <
        select id = "kemudahantk"
        name = "kemudahantk"
        value = { tk.kemudahan }
        onChange = {
            (e) => setTk({...tk, kemudahan: e.target.value }) } >
        <
        option value = "Mudah" > Mudah < /option> <
        option value = "Sulit" > Sulit < /option> <
        /select> <
        ...
        value = { sd.jarak }
        onChange = {
            (e) => setSd({...sd, jarak: e.target.value }) }
        required /
        >
        <
        /CFormLabel> &
        ...
        value = { sd.waktu }
        onChange = {
            (e) => setSd({...sd, waktu: e.target.value }) }
        required /
        >
        <
        /CFormLabel> &
        ...
        Mudah / Sulit ? :
        <
        select id = "kemudahansd"
        name = "kemudahansd"
        value = { sd.kemudahan }
        onChange = {
            (e) => setSd({...sd, kemudahan: e.target.value }) } >
        <
        option value = "Mudah" > Mudah < /option> <
        option value = "Sulit" > Sulit < /option> <
        /select> <
        ...
        value = { smp.jarak }
        onChange = {
            (e) => setSmp({...smp, jarak: e.target.value }) }
        required /
        >
        <
        /CFormLabel> &
        ...
        value = { smp.waktu }
        onChange = {
            (e) => setSmp({...smp, waktu: e.target.value }) }
        required /
        >
        <
        /CFormLabel> &
        ...
        Mudah / Sulit ? :
        <
        select id = "kemudahansmp"
        name = "kemudahansmp"
        value = { smp.kemudahan }
        onChange = {
            (e) => setSmp({...smp, kemudahan: e.target.value }) } >
        <
        option value = "Mudah" > Mudah < /option> <
        option value = "Sulit" > Sulit < /option> <
        /select> <
        ...
        value = { sma.jarak }
        onChange = {
            (e) => setSma({...sma, jarak: e.target.value }) }
        required /
        >
        <
        /CFormLabel> &
        ...
        value = { sma.waktu }
        onChange = {
            (e) => setSma({...sma, waktu: e.target.value }) }
        required /
        >
        <
        /CFormLabel> &
        ...
        Mudah / Sulit ? :
        <
        select id = "kemudahansma"
        name = "kemudahansma"
        value = { sma.kemudahan }
        onChange = {
            (e) => setSma({...sma, kemudahan: e.target.value }) } >
        <
        option value = "Mudah" > Mudah < /option> <
        option value = "Sulit" > Sulit < /option> <
        /select> <
        ...
        value = { pt.jarak }
        onChange = {
            (e) => setPt({...pt, jarak: e.target.value }) }
        required /
        >
        <
        /CFormLabel> &
        ...
        value = { pt.waktu }
        onChange = {
            (e) => setPt({...pt, waktu: e.target.value }) }
        required /
        >
        <
        /CFormLabel> &
        ...
        Mudah / Sulit ? :
        <
        select id = "kemudahanpt"
        name = "kemudahanpt"
        value = { pt.kemudahan }
        onChange = {
            (e) => setPt({...pt, kemudahan: e.target.value }) } >
        <
        option value = "Mudah" > Mudah < /option> <
        option value = "Sulit" > Sulit < /option> <
        /select> <
        ...
        onChange = {
            (e) => setPesantren({...pesantren, jarak: e.target.value }) }
        required /
        >
        <
        /CFormLabel> &
        ...
        onChange = {
            (e) => setPesantren({...pesantren, waktu: e.target.value }) }
        required /
        >
        <
        /CFormLabel> &
        ...
        Mudah / Sulit ? :
        <
        select id = "kemudahanpstrn"
        name = "kemudahanpstrn"
        value = { pesantren.kemudahan }
        onChange = {
            (e) => setPesantren({...pesantren, kemudahan: e.target.value }) } >
        <
        option value = "Mudah" > Mudah < /option> <
        option value = "Sulit" > Sulit < /option> <
        /select> <
        ...
        onChange = {
            (e) => setSeminari({...seminari, jarak: e.target.value }) }
        required /
        >
        <
        /CFormLabel> &
        ...
        onChange = {
            (e) => setSeminari({...seminari, waktu: e.target.value }) }
        required /
        >
        <
        /CFormLabel> &
        ...
        Mudah / Sulit ? :
        <
        select id = "kemudahanseminari"
        name = "kemudahanseminari"
        value = { seminari.kemudahan }
        onChange = {
            (e) => setSeminari({...seminari, kemudahan: e.target.value }) } >
        <
        option value = "Mudah" > Mudah < /option> <
        option value = "Sulit" > Sulit < /option> <
        /select> <
        ...
        onChange = {
            (e) => setKeagamaanLain({...keagamaanLain, jarak: e.target.value }) }
        required /
        >
        <
        /CFormLabel> &
        ...
        onChange = {
            (e) => setKeagamaanLain({...keagamaanLain, waktu: e.target.value }) }
        required /
        >
        <
        /CFormLabel> &
        ...
        Mudah / Sulit ? :
        <
        select id = "kemudahanppai"
        name = "kemudahanppai"
        value = { keagamaanLain.kemudahan }
        onChange = {
            (e) => setKeagamaanLain({...keagamaanLain, kemudahan: e.target.value }) } >
        <
        option value = "Mudah" > Mudah < /option> <
        option value = "Sulit" > Sulit < /option> <
        /select> <
        ...
        value = { rs.jarak }
        onChange = {
            (e) => setRs({...rs, jarak: e.target.value }) }
        required /
        >
        <
        /CFormLabel> &
        ...
        value = { rs.waktu }
        onChange = {
            (e) => setRs({...rs, waktu: e.target.value }) }
        required /
        >
        <
        /CFormLabel> &
        ...
        Mudah / Sulit ? :
        <
        select id = "kemudahanrumahsakit"
        name = "kemudahanrumahsakit"
        value = { rs.kemudahan }
        onChange = {
            (e) => setRs({...rs, kemudahan: e.target.value }) } >
        <
        option value = "Mudah" > Mudah < /option> <
        option value = "Sulit" > Sulit < /option> <
        /select> <
        ...
        value = { rsb.jarak }
        onChange = {
            (e) => setRsb({...rsb, jarak: e.target.value }) }
        required /
        >
        <
        /CFormLabel> &
        ...
        value = { rsb.waktu }
        onChange = {
            (e) => setRsb({...rsb, waktu: e.target.value }) }
        required /
        >
        <
        /CFormLabel> &
        ...
        Mudah / Sulit ? :
        <
        select id = "kemudahanrsbersalin"
        name = "kemudahanrsbersalin"
        value = { rsb.kemudahan }
        onChange = {
            (e) => setRsb({...rs, kemudahan: e.target.value }) } >
        <
        option value = "Mudah" > Mudah < /option> <
        option value = "Sulit" > Sulit < /option> <
        /select> <
        ...
        onChange = {
            (e) => setPoliklinik({...poliklinik, jarak: e.target.value }) }
        required /
        >
        <
        /CFormLabel> &
        ...
        onChange = {
            (e) => setPoliklinik({...poliklinik, waktu: e.target.value }) }
        required /
        >
        <
        /CFormLabel> &
        ...
        Mudah / Sulit ? :
        <
        select id = "kemudahanpoliklinik"
        name = "kemudahanpoliklinik"
        value = { poliklinik.kemudahan }
        onChange = {
            (e) => setPoliklinik({...poliklinik, kemudahan: e.target.value }) } >
        <
        option value = "Mudah" > Mudah < /option> <
        option value = "Sulit" > Sulit < /option> <
        /select> <
        ...
        onChange = {
            (e) => setPuskesmas({...puskesmas, jarak: e.target.value }) }
        required /
        >
        <
        /CFormLabel> &
        ...
        onChange = {
            (e) => setPuskesmas({...puskesmas, waktu: e.target.value }) }
        required /
        >
        <
        /CFormLabel> &
        ...
        Mudah / Sulit ? :
        <
        select id = "kemudahanpuskesmas"
        name = "kemudahanpuskesmas"
        value = { puskesmas.kemudahan }
        onChange = {
            (e) => setPuskesmas({...poliklinik, kemudahan: e.target.value }) } >
        <
        option value = "Mudah" > Mudah < /option> <
        option value = "Sulit" > Sulit < /option> <
        /select> <
        ...
        onChange = {
            (e) => setPuskesmasBantu({...puskesmasBantu, jarak: e.target.value }) }
        required /
        >
        <
        /CFormLabel> &
        ...
        onChange = {
            (e) => setPuskesmasBantu({...puskesmasBantu, waktu: e.target.value }) }
        required /
        >
        <
        /CFormLabel> &
        ...
        Mudah / Sulit ? :
        <
        select id = "kemudahanpustu"
        name = "kemudahanpustu"
        value = { puskesmasBantu.kemudahan }
        onChange = {
            (e) => setPuskesmasBantu({...puskesmasBantu, kemudahan: e.target.value }) } >
        <
        option value = "Mudah" > Mudah < /option> <
        option value = "Sulit" > Sulit < /option> <
        /select> <
        ...
        onChange = {
            (e) => setPolindes({...polindes, jarak: e.target.value }) }
        required /
        >
        <
        /CFormLabel> &
        ...
        onChange = {
            (e) => setPolindes({...polindes, waktu: e.target.value }) }
        required /
        >
        <
        /CFormLabel> &
        ...
        Mudah / Sulit ? :
        <
        select id = "kemudahanpolindes"
        name = "kemudahanpolindes"
        value = { polindes.kemudahan }
        onChange = {
            (e) => setPolindes({...polindes, kemudahan: e.target.value }) } >
        <
        option value = "Mudah" > Mudah < /option> <
        option value = "Sulit" > Sulit < /option> <
        /select> <
        ...
        onChange = {
            (e) => setPoskesdes({...poskesdes, jarak: e.target.value }) }
        required /
        >
        <
        /CFormLabel> &
        ...
        onChange = {
            (e) => setPoskesdes({...poskesdes, waktu: e.target.value }) }
        required /
        >
        <
        /CFormLabel> &
        ...
        Mudah / Sulit ? :
        <
        select id = "kemudahanposkesdes"
        name = "kemudahanposkesdes"
        value = { poskesdes.kemudahan }
        onChange = {
            (e) => setPoskesdes({...poskesdes, kemudahan: e.target.value }) } >
        <
        option value = "Mudah" > Mudah < /option> <
        option value = "Sulit" > Sulit < /option> <
        /select> <
        ...
        onChange = {
            (e) => setPosyandu({...posyandu, jarak: e.target.value }) }
        required /
        >
        <
        /CFormLabel> &
        ...
        onChange = {
            (e) => setPosyandu({...posyandu, waktu: e.target.value }) }
        required /
        >
        <
        /CFormLabel> &
        ...
        Mudah / Sulit ? :
        <
        select id = "kemudahanposyandu"
        name = "kemudahanposyandu"
        value = { posyandu.kemudahan }
        onChange = {
            (e) => setPosyandu({...posyandu, kemudahan: e.target.value }) } >
        <
        option value = "Mudah" > Mudah < /option> <
        option value = "Sulit" > Sulit < /option> <
        /select> <
        ...
        value = { apotek.jarak }
        onChange = {
            (e) => setApotek({...apotek, jarak: e.target.value }) }
        required /
        >
        <
        /CFormLabel> &
        ...
        value = { apotek.waktu }
        onChange = {
            (e) => setApotek({...apotek, waktu: e.target.value }) }
        required /
        >
        <
        /CFormLabel> &
        ...
        Mudah / Sulit ? :
        <
        select id = "kemudahanapotek"
        name = "kemudahanapotek"
        value = { apotek.kemudahan }
        onChange = {
            (e) => setApotek({...apotek, kemudahan: e.target.value }) } >
        <
        option value = "Mudah" > Mudah < /option> <
        option value = "Sulit" > Sulit < /option> <
        /select> <
        ...
        CFormLabel htmlFor = "lokasiputama" > Lokasi Pekerjaan Utama & nbsp; < /CFormLabel> <
        select id = "lokasiputama"
        name = "lokasiputama"
        value = { aksesKerja }
        onChange = {
            (e) => setAksesKerja(e.target.value) } >
        <
        option value = "Mudah" > Mudah < /option> <
        option value = "Sulit" > Sulit < /option> <
        /select> <
        br > < /br> <
        CFormLabel htmlFor = "lahanpertanian" > Lahan pertanian & nbsp; < /CFormLabel> <
        select id = "lahanpertaniani"
        name = "lahanpertanian"
        value = { aksesLahan }
        onChange = {
            (e) => setAksesLahan(e.target.value) } >
        <
        option value = "Mudah" > Mudah < /option> <
        option value = "Sulit" > Sulit < /option> <
        /select> <
        br > < /br> <
        CFormLabel htmlFor = "sekolahsarana" > Sekolah & nbsp; < /CFormLabel> <
        select id = "sekolahsarana"
        name = "sekolahsarana"
        value = { aksesSekolah }
        onChange = {
            (e) => setAksesSekolah(e.target.value) } >
        <
        option value = "Mudah" > Mudah < /option> <
        option value = "Sulit" > Sulit < /option> <
        /select> <
        br > < /br> <
        CFormLabel htmlFor = "faskes" > Fasilitas Kesehatan & nbsp; < /CFormLabel> <
        select id = "faskes"
        name = "faskes"
        value = { aksesKesehatan }
        onChange = {
            (e) => setAksesKesehatan(e.target.value) } >
        <
        option value = "Mudah" > Mudah < /option> <
        option value = "Sulit" > Sulit < /option> <
        /select> <
